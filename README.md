...
| $wgBaiduSiteVerificationKey          | Setting this variable will add a `<meta name="baidu-site-verification" content="CODE">` tag to every page.                                                                                                                                                                 | $wgBaiduSiteVerificationKey = 'CODE';                          |
| General Options                      |                                                                                                                                                                                                                                                                            |                                                                |
